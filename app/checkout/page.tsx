...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    if (!isLoading && isEmpty && currentStep !== "confirmation") {
      router.push("/cart")
    }
  }, [isEmpty, router, currentStep, isLoading])

  // If user is not logged in, redirect to login
  useEffect(() => {
    if (!isLoading && !user && currentStep !== "confirmation") {
      router.push("/login?redirectTo=/checkout")
    }
  }, [user, router, currentStep, isLoading])
