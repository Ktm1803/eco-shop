...
export function Navbar() {
  ...
  // Add useEffect to ensure client-side rendering only
  useEffect(() => {
    setIsMounted(true)
  }, [])
                    ...
                    <>
                      ...
                      {isAdmin && (
                        ...
                        >
                          ...
                          <span className="ml-2 px-1.5 py-0.5 rounded text-xs bg-primary text-primary-foreground">
                            Admin
                          </span>
                        </Link>
                      )}
            ...
            {user ? (
              ...
              <Link href="/login">
                <Button variant="ghost" size="icon" className="relative group">
                  ...
                  <span className="absolute -bottom-9 left-1/2 transform -translate-x-1/2 bg-primary text-primary-foreground text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    {t("nav.login")}
                  </span>
                </Button>
              </Link>
